...
>
> ![](./CircuitBoard/circuit_boards.png)
> 
...
>
> **<font color=red>补充说明 1：wine 的执行环境仅包含 c: 的默认磁盘映射，z: 的磁盘映射已被删除。</font>**

注：“上回”指“家目录里的秘密”那道题。

### 题目内容

题目地址：网页 `http://202.38.93.111:10050/`
...
上传程序并运行，系统会显示其标准输出 (`stdout`) 和标准错误 (`stderr`) 信息。
...
> 
> <mdc-fakeh2>XZRJification Standard</mdc-fakeh2>
> 
...
> 
> <mdc-fakeh2>Your Task</mdc-fakeh2>
> 
...
> 
> <mdc-fakeh2>Notes</mdc-fakeh2>
> 
> This articl has been procesed through XZRJification.
> 
> ---
> 
> **<font color=red>补充说明 1：在本题中没有大写字母因「惜字如金化」而被删除。</font>**  
> **<font color=red>No capital leters in this chaleng hav been deleted due to "XZRJification".</font>**


### 题目内容

题目地址：网页 `http://202.38.93.111:10120/`

![](./XZRJification/page.png)

概要：你需要使用给定的程序完成对三个二进制文件的签名。但是，程序经过了惜字如金化处理，无法直接使用。

程序：[HS384](./XZRJification/HS384.py) [RS384](./XZRJification/RS384.py)
...
题目地址：[文件](./PulseView/sdcard_data_pulseview.zip) `https://hack.lug.ustc.edu.cn/media/1801361c-b579-59c1-af06-5f3b5abbeffb/sdcard_data_pulseview.zip`
...
> 
> 判题脚本：[下载](./OnlineJudge/online_judge.py)
> 
> 你可以通过 `nc 202.38.93.111 10027` 来连接题目，或者点击下面的 "打开/下载题目" 按钮通过网页终端与远程交互。

### 题目内容

题目地址：终端 `http://202.38.93.111:10028/`
...
> 
> [构建环境相关的 Dockerfile 附件](./SeparateJail/kanata.zip)

### 题目内容

题目地址：网页 `http://202.38.93.111:10040/`

<mdc-imgborder>

![](./SeparateJail/run.png)

</mdc-imgborder>

选手需要上传两个二进制文件，其中 Bob 的标准输出和标准错误会返回到网页。
